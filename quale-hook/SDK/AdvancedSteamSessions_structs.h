...
struct FBPSteamGroupInfo
{
	...
	unsigned char                                      UnknownData_3ZE2[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GWQD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FBPSteamWorkshopItemDetails
{
	...
	unsigned char                                      UnknownData_08R4[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q2VZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TK82[0x1];                                     // 0x004F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBPSteamGroupOfficer
{
	...
	unsigned char                                      UnknownData_1884[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
