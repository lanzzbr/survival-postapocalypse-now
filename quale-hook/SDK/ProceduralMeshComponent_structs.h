...
struct FProcMeshTangent
{
	...
	unsigned char                                      UnknownData_18K5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FProcMeshSection
{
	...
	TArray<int>                                        ProcIndexBuffer;                                           // 0x0010(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_3JAY[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
