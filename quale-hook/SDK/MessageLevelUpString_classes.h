...
public:
	...
	class UMaterialInstanceDynamic*                    MatInstance;                                               // 0x0218(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(64098);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MessageLevelUpString(int EntryPoint);
};
