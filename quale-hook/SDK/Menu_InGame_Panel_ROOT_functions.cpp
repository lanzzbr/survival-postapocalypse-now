...
void UMenu_InGame_Panel_ROOT_C::STATIC_On_Open()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(63336);
...
void UMenu_InGame_Panel_ROOT_C::STATIC_ExecuteUbergraph_Menu_InGame_Panel_ROOT(int EntryPoint)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(63334);
