...
public:
	...
	class UTextBlock*                                  TextBlock_86;                                              // 0x0218(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(62790);
		return ptr;
	}



	void STATIC_DrawXKIllsWidget(int Kills);
	void STATIC_ExecuteUbergraph_KillsMultiplier_WB(int EntryPoint);
};
