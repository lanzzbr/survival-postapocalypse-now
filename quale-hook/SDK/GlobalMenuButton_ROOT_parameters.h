...
struct UGlobalMenuButton_ROOT_C_ExecuteUbergraph_GlobalMenuButton_ROOT_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function GlobalMenuButton_ROOT.GlobalMenuButton_ROOT_C.OnClick__DelegateSignature
struct UGlobalMenuButton_ROOT_C_OnClick__DelegateSignature_Params
{
};
