...
void UPointer_Root_C::STATIC_UpdateState()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(38622);
...
// (Final, RequiredAPI, BlueprintAuthorityOnly, BlueprintCosmetic, Net, NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast)
void UPointer_Root_C::STATIC_UpdatePositionInViewport()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(38620);
