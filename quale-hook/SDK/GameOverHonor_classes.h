...
// 0x0019 (FullSize[0x0219] - InheritedSize[0x0200])
...
public:
	...
	TEnumAsByte<Cv3_HonorsEnum_ECv3_HonorsEnum>        Honor;                                                     // 0x0218(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(45998);
		return ptr;
	}
	...
	void STATIC_ShowMe();
	void STATIC_ExecuteUbergraph_GameOverHonor(int EntryPoint);
};
