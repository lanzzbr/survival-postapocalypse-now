...
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15102);
...
void UCineCameraComponent::STATIC_SetLensPresetByName(const struct FString& InPresetName)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15154);
...
// Parameters:
// struct FString                 InPresetName                   (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void UCineCameraComponent::STATIC_SetFilmbackPresetByName(const struct FString& InPresetName)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15152);
...
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15150);
...
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15148);
...
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15146);
...
{
	static auto fn = UObject::GetObjectCasted<UFunction>(15144);
