...
void UGameOverStatistic_C::STATIC_Construct()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(42887);
...
// (Final, RequiredAPI, BlueprintAuthorityOnly, BlueprintCosmetic, Net, NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast)
void UGameOverStatistic_C::STATIC_ShowStat()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(42888);
...
void UGameOverStatistic_C::STATIC_ExecuteUbergraph_GameOverStatistic(int EntryPoint)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(42880);
