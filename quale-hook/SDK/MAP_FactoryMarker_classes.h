...
// WidgetBlueprintGeneratedClass MAP_FactoryMarker.MAP_FactoryMarker_C
// 0x0012 (FullSize[0x0248] - InheritedSize[0x0236])
class UMAP_FactoryMarker_C : public UMapMarkerROOT_C
{
public:
	unsigned char                                      UnknownData_GAVX[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95560);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MAP_FactoryMarker(int EntryPoint);
};
