...
// WidgetBlueprintGeneratedClass RegionAttack.RegionAttack_C
// 0x0037 (FullSize[0x0258] - InheritedSize[0x0221])
class URegionAttack_C : public UPointer_Root_C
{
public:
	unsigned char                                      UnknownData_STVF[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(38742);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_RegionAttack(int EntryPoint);
};
