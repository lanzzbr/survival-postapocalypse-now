...
// WidgetBlueprintGeneratedClass MAP_TowerMarker.MAP_TowerMarker_C
// 0x0022 (FullSize[0x0258] - InheritedSize[0x0236])
class UMAP_TowerMarker_C : public UMapMarkerROOT_C
{
public:
	unsigned char                                      UnknownData_BVUE[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95312);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MAP_TowerMarker(int EntryPoint);
};
