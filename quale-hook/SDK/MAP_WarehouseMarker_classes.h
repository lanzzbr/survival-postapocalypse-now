...
// WidgetBlueprintGeneratedClass MAP_WarehouseMarker.MAP_WarehouseMarker_C
// 0x0012 (FullSize[0x0248] - InheritedSize[0x0236])
class UMAP_WarehouseMarker_C : public UMapMarkerROOT_C
{
public:
	unsigned char                                      UnknownData_E5G0[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95228);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MAP_WarehouseMarker(int EntryPoint);
};
