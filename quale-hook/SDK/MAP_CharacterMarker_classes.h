...
{
public:
	unsigned char                                      UnknownData_J4UT[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95746);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MAP_CharacterMarker(int EntryPoint);
};
