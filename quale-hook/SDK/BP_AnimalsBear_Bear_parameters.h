...
struct ABP_AnimalsBear_Bear_C_BndEvt__PawnSensing_K2Node_ComponentBoundEvent_6_SeePawnDelegate__DelegateSignature_Params
{
	class APawn*                                       Pawn;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_AnimalsBear_Bear.BP_AnimalsBear_Bear_C.ReceiveAnyDamage
struct ABP_AnimalsBear_Bear_C_ReceiveAnyDamage_Params
{
...
struct ABP_AnimalsBear_Bear_C_ServerDestroyActor_Params
{
};

// Function BP_AnimalsBear_Bear.BP_AnimalsBear_Bear_C.ExecuteUbergraph_BP_AnimalsBear_Bear
struct ABP_AnimalsBear_Bear_C_ExecuteUbergraph_BP_AnimalsBear_Bear_Params
{
