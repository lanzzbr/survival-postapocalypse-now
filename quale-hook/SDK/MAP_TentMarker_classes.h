...
// WidgetBlueprintGeneratedClass MAP_TentMarker.MAP_TentMarker_C
// 0x001A (FullSize[0x0250] - InheritedSize[0x0236])
class UMAP_TentMarker_C : public UMapMarkerROOT_C
{
public:
	unsigned char                                      UnknownData_YT6F[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95347);
		return ptr;
	}
	...
	void STATIC_BndEvt__Button_0_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature();
	void STATIC_SetSelectedStyle();
	void STATIC_SetUnselectedStyle();
	void STATIC_ExecuteUbergraph_MAP_TentMarker(int EntryPoint);
};
