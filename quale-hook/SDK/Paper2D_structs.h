...
struct FPaperSpriteSocket
{
	...
	unsigned char                                      UnknownData_E8OE[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FPaperSpriteAtlasSlot
{
	...
	unsigned char                                      UnknownData_BBO8[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTerrainMaterialRule
{
	...
	unsigned char                                      UnknownData_1JN5[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4OT2[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileInfo
{
	...
	unsigned char                                      UnknownData_WMGH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileSetTerrain
{
	...
	unsigned char                                      UnknownData_JGPN[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryShape
{
	...
	unsigned char                                      UnknownData_02ON[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPDQ[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryCollection
{
	...
	unsigned char                                      UnknownData_3D7P[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B33V[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SSC7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileMetadata
{
	...
	unsigned char                                      UnknownData_1HMD[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperFlipbookKeyFrame
{
	...
	unsigned char                                      UnknownData_DYRY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteDrawCallRecord
{
	...
	unsigned char                                      UnknownData_A635[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ABZ[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FColor                                      Color;                                                     // 0x0048(0x0004) (IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_X2WD[0x84];                                    // 0x004C(0x0084) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9LUY[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
