...
struct UInventoryRenderWidget_C_OnDrop_Params
{
...
struct UInventoryRenderWidget_C_OnMouseButtonUp_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UInventoryRenderWidget_C_OnMouseButtonDown_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                               MouseEvent;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                                 ReturnValue;                                               // (Parm, OutParm, ReturnParm)
...
struct UInventoryRenderWidget_C_Construct_Params
{
};

// Function InventoryRenderWidget.InventoryRenderWidget_C.Tick
struct UInventoryRenderWidget_C_Tick_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UInventoryRenderWidget_C_OnMouseLeave_Params
{
	struct FPointerEvent                               MouseEvent;                                                // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};

// Function InventoryRenderWidget.InventoryRenderWidget_C.ExecuteUbergraph_InventoryRenderWidget
struct UInventoryRenderWidget_C_ExecuteUbergraph_InventoryRenderWidget_Params
{
