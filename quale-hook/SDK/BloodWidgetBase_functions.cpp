...
void UBloodWidgetBase_C::STATIC_ShowBlood()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(77614);
...
void UBloodWidgetBase_C::STATIC_ExecuteUbergraph_BloodWidgetBase(int EntryPoint)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(77609);
