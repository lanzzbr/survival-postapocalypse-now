...
struct FMaterialQualityOverrides
{
	...
	MaterialShaderQualitySettings_EMobileCSMQuality    MobileCSMQuality;                                          // 0x0005(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
