...
// WidgetBlueprintGeneratedClass MAP_SpawnMarker.MAP_SpawnMarker_C
// 0x001A (FullSize[0x0250] - InheritedSize[0x0236])
class UMAP_SpawnMarker_C : public UMapMarkerROOT_C
{
public:
	unsigned char                                      UnknownData_IIGS[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::GetObjectCasted<UClass>(95380);
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_MAP_SpawnMarker(int EntryPoint);
};
