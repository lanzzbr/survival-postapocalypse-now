...
struct FBox2D
{
	...
	unsigned char                                      UnknownData_SMBM[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FVector
{
	...
	inline float Size() { return sqrt(X * X + Y * Y + Z * Z); }
...
struct FInterpCurvePointLinearColor
{
	...
	unsigned char                                      UnknownData_9GPI[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveLinearColor
{
	...
	unsigned char                                      UnknownData_9JCD[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransform
{
	...
	unsigned char                                      UnknownData_JJUK[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimespan
{
	unsigned char                                      UnknownData_1VTQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FBox
{
	...
	unsigned char                                      UnknownData_TRI0[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FJoinabilitySettings
{
	...
	unsigned char                                      UnknownData_G7DH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J0QP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0SNY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFloatRangeBound
{
	...
	unsigned char                                      UnknownData_SMXZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_U4WW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector
{
	...
	unsigned char                                      UnknownData_TQP7[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_35W6[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GTBG[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RLHM[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
...
struct FInterpCurveQuat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_732Z[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointTwoVectors
{
	...
	unsigned char                                      UnknownData_F4UY[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveTwoVectors
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_9YXS[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointFloat
{
	...
	unsigned char                                      UnknownData_FR02[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveFloat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NXU5[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointVector2D
{
	...
	unsigned char                                      UnknownData_BHDO[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector2D
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7WPO[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FDateTime
{
	unsigned char                                      UnknownData_66Q1[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAutomationEvent
{
	...
	unsigned char                                      UnknownData_X0Z5[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     Filename;                                                  // 0x0028(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                LineNumber;                                                // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I59X[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
