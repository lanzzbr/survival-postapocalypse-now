...
void UCreature_Bear_DeadAnimBP_C::STATIC_ExecuteUbergraph_Creature_Bear_DeadAnimBP(int EntryPoint)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(92824);
