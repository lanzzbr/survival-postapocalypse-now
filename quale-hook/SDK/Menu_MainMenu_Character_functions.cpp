...
void UMenu_MainMenu_Character_C::STATIC_Construct()
{
	static auto fn = UObject::GetObjectCasted<UFunction>(78101);
...
void UMenu_MainMenu_Character_C::STATIC_ExecuteUbergraph_Menu_MainMenu_Character(int EntryPoint)
{
	static auto fn = UObject::GetObjectCasted<UFunction>(78096);
