...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_EYXR[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_B1D2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_EYGO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_PU62[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QM1Y[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_6WMF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H22V[0x18];                                    // 0x0070(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TZ48[0x10];                                    // 0x04C0(0x0010) MISSED OFFSET (PADDING)
